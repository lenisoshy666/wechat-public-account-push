export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  /wx147005642348b2e2/ ， ”  APP_ID：“

  // 公众号APP_SECRET 
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  // APP_SECRET: "wx147005642348b2e2“
   * 接收公众号消息，如果有多个，需要在[]里用空格的微信，例如”
   * [
   *  {
   *    // 想要发送的人的名字
   *    名称：“双双”
   *       // 扫关注你的微信测试号后生成的一段字符串代码，在测试号后台能看到
  ...
  USERS: [
    {
      ...
      // 所在城市
      城市：“乌鲁木齐沙依巴克区”
      //他点击详情后跳转的，你可以设置一下博博的热度排行榜，设置其他的网址，也一定要重对；不要对不上的关系，顺便说一下，会打不开。
      openUrl: "https://wangxinleo.cn"
    }, 
    {
      name: "老婆1", 
